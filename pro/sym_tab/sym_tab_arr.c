...
#include<ctype.h>
#include<string.h>
char keyword[30][30]={"num","deci","loop","if","else","while","get","function","class","void","return"};
char id[20], num[10], dislge[2];
...
fp1=fopen("x.text","r");//input file containing src prog
fp2=fopen("y.text","w");//output file name
